 ...
 */
public class CircularDeque<E> extends AbstractCollection<E> implements Deque<E>, Cloneable, Serializable {
	/**
	 ...
	 */
	public CircularDeque(int numElements) {
	 ...
	 */
	public CircularDeque(Collection<? extends E> c) {
	 ...
	 */
	public CircularDeque<E> clone() {
		try {
			CircularDeque<E> result = (CircularDeque<E>) super.clone();
